...
const getPackageManagerVersion = async (packageManager: string, command: string) => {
...
export const getCacheDirectoryPath = async (packageManagerInfo: PackageManagerInfo, packageManager: string) => {
  const stdOut = await getCommandOutput(packageManagerInfo.getCacheFolderCommand);
